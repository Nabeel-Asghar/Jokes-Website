...
<h3>These reviewers never posted a poor/horrible review</h3>
...
String sql = "SELECT * from users WHERE username not in(SELECT reviewer from reviews WHERE score ='Horrible')";
